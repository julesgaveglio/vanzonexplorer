    ...
    <div className="flex flex-col gap-3">
      ...
      {isWhatsApp ? (
        <a
          ...
          className="w-full inline-flex items-center justify-center gap-2.5 px-5 py-3.5 rounded-2xl font-bold text-white text-sm transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
        ...
        /* Bouton plateforme — rose Yescapa ou orange Wikicampers */
        <LiquidButton
