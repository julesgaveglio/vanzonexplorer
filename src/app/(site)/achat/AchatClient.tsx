          ...
          <div className="bg-slate-900 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row gap-8 items-center justify-between">
            <div className="max-w-lg">
              ...
              <p className="text-slate-400 leading-relaxed text-sm">
                Jules vous accompagne pour trouver le fourgon qui correspond à votre projet — sélection, inspection mécanique, négociation et démarches administratives de A à Z.
              </p>
            </div>
