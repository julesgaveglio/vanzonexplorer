...
export const metadata: Metadata = {
  ...
  description:
    "Yoni, Renault Trafic III aménagé par nos soins en 2024. 190 000 km, lit fixe, cuisine coulissante, panneau solaire. Historique complet, 19 900 €. Remise à Cambo-les-Bains.",
  keywords: [
  ...
  openGraph: {
    title: "Yoni — Renault Trafic aménagé 2024, 19 900 €",
