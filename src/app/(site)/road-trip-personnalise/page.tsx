    ...
    <>
      ...
      <div className="relative min-h-screen">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-16 text-center">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8 text-sm font-medium bg-white/50 backdrop-blur-md border border-white/60 text-slate-700 shadow-sm">
            <span className="w-2 h-2 rounded-full bg-teal-500 animate-pulse inline-block" />
            Propulsé par l&apos;intelligence artificielle
          </div>

          {/* H1 */}
          <h1 className="font-bold text-slate-900 text-5xl sm:text-6xl md:text-7xl xl:text-8xl leading-none tracking-tight mb-6 max-w-4xl">
            Ton road trip van
            <br />
            <span
              style={{
                background: 'linear-gradient(135deg, #0d9488 0%, #0ea5e9 45%, #B9945F 100%)',
          ...
          {/* Accroche */}
          <p className="text-lg sm:text-xl text-slate-700 max-w-xl mx-auto leading-relaxed mb-10">
            Remplis le formulaire — l&apos;IA génère ton itinéraire jour par jour avec les meilleurs spots, campings et conseils.{' '}
            <strong className="text-slate-900 font-semibold">Reçu par email en 60 secondes.</strong>
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-10">
            {['✨ Généré par IA', '📍 Toute la France', '⚡ 60 secondes', '🎁 100% gratuit'].map((label) => (
              <span
                key={label}
                className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-white/55 backdrop-blur-sm text-slate-700 border border-white/70 shadow-sm"
              >
                {label}
              </span>
            ))}
          ...
          <a
            ...
            style={{
              ...
              boxShadow: '0 8px 32px rgba(15,23,42,0.22), inset 0 1px 0 rgba(255,255,255,0.08)',
            }}
          >
          ...
          <div className="mt-12 flex flex-col items-center gap-2 opacity-40">
            <div className="w-px h-10 bg-slate-700" style={{ animation: 'pulse 2s infinite' }} />
          </div>
        </section>
        ...
        <section id="wizard" className="py-20 px-6">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="text-center mb-10">
              <p className="text-sm font-bold uppercase tracking-widest text-teal-700 mb-3">Le générateur</p>
            ...
            <div
              ...
              style={{
                ...
                boxShadow: '0 24px 64px rgba(15,23,42,0.12), 0 1px 0 rgba(255,255,255,0.9) inset',
              }}
            >
        ...
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <p className="text-sm font-bold uppercase tracking-widest text-teal-700 mb-3">Comment ça marche</p>
        ...
        <section className="py-24 px-6">
          ...
          >
            ...
            <p className="text-slate-300 leading-relaxed mb-10 max-w-md mx-auto">
              Loue un van Vanzon Explorer tout équipé — literie, cuisine, GPS — et pars sur la route dès demain.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#wizard"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full text-sm font-semibold text-slate-900 bg-white hover:bg-white/90 transition-all"
              >
