...
export default async function LocationWeekEndPage() {
  ...
  return (
    <>
      ...
      {/* ── CTA FINAL ────────────────────────────────────────────── */}
      <FinalBookingCTA
        title={<>Ce week-end,<br />le Pays Basque en van.</>}
        subtitle={<><strong className="text-white">2 nuits dès 130€</strong> — assurance incluse, van tout équipé, spots partagés par Jules.</>}
        linkHref="/road-trip-pays-basque-van"
        linkLabel="Voir notre itinéraire road trip Pays Basque 7 jours"
      />
    </>
  );
}
