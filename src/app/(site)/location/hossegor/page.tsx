...
export default async function LocationHossegorPage() {
  const [heroPhoto, activityImages, placeStats] =
    await Promise.all([
      ...
      fetchSerpApiImages([
        "La Gravière Hossegor surf vague tubulaire barrel",
        "Les Estagnots Hossegor plage surf intermédiaire",
        "Forêt des Landes pins dunes piste cyclable",
        "Côte sauvage Landes plage immense sable vide",
        "Hossegor lac marin village surf boutiques",
        "Capbreton port pêche jetée coucher soleil thon",
      ], FALLBACK_IMG),
      getGooglePlaceStats(),
    ]);
