...
export default function LocationBiarritzPage() {
  return (
    <>
      {/* Hero */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pb-20 pt-32 w-full">
          ...
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-white/90 text-sm font-medium">33 avis Google · Départ Bayonne</span>
            </div>
      ...
      <section className="bg-slate-950 py-5 border-t border-white/5">
        <div className="max-w-5xl mx-auto px-6">
          <div className="flex flex-wrap justify-center md:justify-between items-center gap-y-4 gap-x-8 text-white/60 text-sm font-medium">
            {[
              { icon: "📍", text: "Départ Bayonne — 20 min de Biarritz" },
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                {[
                  { label: "Récupération du van", value: "Bayonne (20 min de Biarritz) ou livraison sur demande" },
