...
export default function VBAVideoPlayer({
  ...
  return (
    <div className="mb-4 sm:mb-6">
      <iframe
        ref={iframeRef}
        src={`https://iframe.mediadelivery.net/embed/${libraryId}/${videoId}?autoplay=false&loop=false&muted=false&preload=true&responsive=true&captions=fr&captionsFontSize=${captionSize}&captionsFontColor=%23ffffff&playerColor=%23B9945F`}
