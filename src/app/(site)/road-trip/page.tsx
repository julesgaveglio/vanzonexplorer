      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-slate-500 max-w-2xl mx-auto">
            {articles.length > 0 ? `${articles.length} itinéraire${articles.length > 1 ? "s" : ""}` : "Des itinéraires"} détaillés avec spots GPS, campings et cartes interactives.
            Du Pays Basque à la Bretagne, partez à l&apos;aventure en van aménagé.
          </p>
        </div>

        {/* Recherche + Carte + Grille (client) */}
        <RoadTripCatalogClient articles={articles} />
