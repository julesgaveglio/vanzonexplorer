...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/road-trip-pays-basque-van/weekend/famille`, lastModified: new Date("2026-04-11"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/road-trip-pays-basque-van/5-jours/solo`, lastModified: new Date("2026-04-11"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/road-trip-pays-basque-van/5-jours/couple`, lastModified: new Date("2026-04-11"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/road-trip-pays-basque-van/5-jours/amis`, lastModified: new Date("2026-04-11"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/road-trip-pays-basque-van/5-jours/famille`, lastModified: new Date("2026-04-11"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/road-trip-pays-basque-van/1-semaine/solo`, lastModified: new Date("2026-04-11"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/road-trip-pays-basque-van/1-semaine/couple`, lastModified: new Date("2026-04-11"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/road-trip-pays-basque-van/1-semaine/amis`, lastModified: new Date("2026-04-11"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/road-trip-pays-basque-van/1-semaine/famille`, lastModified: new Date("2026-04-11"), changeFrequency: "monthly", priority: 0.8 },
