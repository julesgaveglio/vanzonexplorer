...
const FUNNEL_COLORS: Record<string, string> = {
  ...
  optin: "linear-gradient(90deg, #7DD3FC, #38BDF8)",
  vsl_25: "linear-gradient(90deg, #38BDF8, #0EA5E9)",
  vsl_50: "linear-gradient(90deg, #0EA5E9, #0284C7)",
  vsl_75: "linear-gradient(90deg, #0284C7, #0369A1)",
  vsl_100: "linear-gradient(90deg, #0369A1, #1D4ED8)",
  booking_start: "linear-gradient(90deg, #1D4ED8, #1E40AF)",
  booking_confirmed: "linear-gradient(90deg, #1E40AF, #1E3A8A)",
  checkout: "linear-gradient(90deg, #1E3A8A, #172554)",
