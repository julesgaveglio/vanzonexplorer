              ...
              >
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-slate-50">
                  ...
                  {(product.affiliateUrl && product.affiliateUrl !== "/") && (
                    ...
                    >
                      <span className="inline-flex items-center gap-1.5 rounded-full bg-violet-600 px-5 py-2.5 text-sm font-semibold text-white">
                        Voir l&apos;offre
                        <ArrowRight className="h-3.5 w-3.5" />
                      </span>
                    </Link>
                ...
                <div className="bg-white px-4 py-3">
                  ...
                  {/* Code promo + bouton voir l'offre — visible pour tous */}
