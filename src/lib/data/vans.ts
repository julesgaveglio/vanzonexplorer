...
export const VANS: VanData[] = [
  ...
  },
  {
    ...
    highlights: ["Lit fixe 2 pers.", "Cuisine coulissante", "Panneau solaire", "100Ah lithium"],
    description:
      "Xalbat est notre dernier aménagement, réalisé par nos soins en 2025. L'aménagement le plus récent de notre flotte, construit selon les mêmes standards que nos véhicules de location, avec historique complet depuis l'achat. Disponible à Cambo-les-Bains, remise en main propre.",
    whatsapp:
