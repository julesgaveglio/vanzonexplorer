...
async function importAllReviews() {
  try {
    console.log("🔍 Récupération de TOUS les avis Google Places...");
    ...
    // Supprimer les anciens témoignages Google Maps pour éviter les doublons
...
// Supprimer les anciens témoignages Google Maps
async function deleteOldGoogleReviews() {
  try {
    console.log("🗑️ Suppression des anciens témoignages Google Maps...");
    ...
    for (const review of oldReviews) {
      ...
      console.log(`🗑️ Supprimé: ${review.name}`);
    }
