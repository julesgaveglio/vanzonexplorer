...
Construire et aménager 2 vans supplémentaires en 2026, financés via l'apport de Mario (fonds propres SAS).

| Paramètre | Valeur |
|---|---|
| Budget total | 38 000€ |
| Passage en | VASP (Véhicule Aménagé Spécialement) |
| Phase 1 | Exploitation en location (génère du CA immédiat) |
| Phase 2 | Revente dans 2-3 ans |
| Prix de revente estimé | 50 000 – 55 000€ |
| Plus-value potentielle | ~12 000 – 17 000€ brut |

**Nécessite endettement** — pas un investissement cash.

---

## État au 2026-04-04

**Bloqué.** Mario n'a pas encore injecté les fonds.

**Raison** : Mario gère actuellement des problèmes internes chez SigmaFactory.fr (son entreprise principale). Cela crée des retards en cascade sur :
- Le lancement de la formation VBA
- L'injection des fonds pour les vans supplémentaires

Pas de timeline engagée à ce jour.
